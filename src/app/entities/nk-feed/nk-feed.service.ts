...
import { IFeed } from './../models/nk-feed.model';
...
export class FeedService {
  ...
  protected resourceUrl =
    this.applicationConfigService.getEndpointFor("core/feeds");

  protected publicResourceUrl =
    this.applicationConfigService.getEndpointFor("core/r/feeds");
  ...
  query(req?: any): Observable<HttpResponse<IPage<IFeed>>> {
    const options = createRequestOption(req);
    return this.http.get<IPage<IFeed>>(this.publicResourceUrl, {
      params: options,
      observe: "response",
    });
  }
